        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServingsTier = table.Column<int>(type: "int", nullable: false),
                    TimeToMakeTier = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recipes_AspNetUsers_UpdaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeComments_AspNetUsers_UpdaterId",
                        column: x => x.UpdaterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentReplies_AspNetUsers_UpdaterId",
                        column: x => x.UpdaterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReplies_CreatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReplies_UpdaterId",
                table: "CommentReplies",
                column: "UpdaterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReplyLikes_CreatorId",
                table: "CommentReplyLikes",
                column: "CreatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeCommentLikes_CreatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeComments_CreatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeComments_UpdaterId",
                table: "RecipeComments",
                column: "UpdaterId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeLikes_CreatorId",
                table: "RecipeLikes",
                column: "CreatorId");
